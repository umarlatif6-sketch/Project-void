...
# Mesa Engine glyphs for agent identification
ARCHETYPE_MAP = {
    "◆": {"role": "core", "trait": "stabilises", "bias": "anchoring"},
    "◇": {"role": "node", "trait": "relays", "bias": "networking"},
    "◈": {"role": "harmonic", "trait": "harmonises", "bias": "balance"},
...
def _assign_agent_glyph(agent_id: int) -> str:
    """Assign a deterministic glyph to an agent using Mesa pattern."""
    digest = hashlib.sha256(f"{agent_id}nft_slot".encode()).hexdigest()
